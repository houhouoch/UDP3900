...
void setup_scr_HOME_MENU(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->HOME_MENU_label_menu, 1, 99);
    ...
    lv_obj_set_pos(ui->HOME_MENU_label_menu_Config, 17, 92);
    lv_obj_set_size(ui->HOME_MENU_label_menu_Config, 98, 29);
    ...
    lv_obj_set_size(ui->HOME_MENU_label_menu_general, 101, 25);
    ...
    lv_obj_set_pos(ui->HOME_MENU_label_menu_Admin, 592, 327);
