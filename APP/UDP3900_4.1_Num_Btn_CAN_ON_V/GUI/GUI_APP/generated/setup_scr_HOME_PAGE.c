...
void setup_scr_HOME_PAGE(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->HOME_PAGE_edit_IUnit_neg, "");
    lv_label_set_long_mode(ui->HOME_PAGE_edit_IUnit_neg, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->HOME_PAGE_edit_IUnit_neg, 181, 163);
    ...
    lv_obj_set_style_pad_top(ui->HOME_PAGE_edit_Iset_neg, 13, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->HOME_PAGE_edit_IUnit_pos, "");
    lv_label_set_long_mode(ui->HOME_PAGE_edit_IUnit_pos, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->HOME_PAGE_edit_IUnit_pos, 181, 107);
    ...
    lv_obj_set_style_pad_top(ui->HOME_PAGE_edit_Iset_pos, 31, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->HOME_PAGE_back_edit_v_set, &lv_font_SourceHanSerifSC_Regular_35, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->HOME_PAGE_edit_VUnit, "");
    lv_label_set_long_mode(ui->HOME_PAGE_edit_VUnit, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->HOME_PAGE_edit_VUnit, 181, 37);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_edit_Vset, 1, -1);
    ...
    lv_obj_set_style_text_color(ui->HOME_PAGE_label_CV, lv_color_hex(0xff0034), LV_PART_MAIN|LV_STATE_DEFAULT);
