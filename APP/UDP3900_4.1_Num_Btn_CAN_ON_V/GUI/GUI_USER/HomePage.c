...
//#define DEFAULT_INDEX_A  3
//// 定义步进数组 (根据你的项目实际定义)
//const float A_neg_step[5] = { 0.001, 0.01, 0.1, 1.0, 10.0};
//#define AMP_neg_SET_FORM        "-%0.3f"
//#define DEFAULT_INDEX_A_neg  3
...
//            // 关键：传入 fabs() 绝对值，符号由 AMP_neg_SET_FORM 里的 "-" 固定提供
//            Set_RefreshUI(obj, &index_a_neg, AMP_neg_SET_FORM, fabs(IF_Power_Get_OutCurr()));
//            break;
//        }
...
//                    break;
//                case LV_KEY_LEFT:
//                    if(index_a_neg < 5) index_a_neg++; // 根据步进数组长度限制
//                    break;
//                case LV_KEY_RIGHT:
...
//            // 限制最大值不越过 0（既然是负电流调节，确保它一直是负的）
//            if(current_a_neg > 0) current_a_neg = 0; 
//            
//            IF_Power_Set_OutCurr(current_a_neg);
//            // 同样使用 fabs() 刷新
//            Set_RefreshUI(obj, &index_a_neg, AMP_neg_SET_FORM, fabs(current_a_neg));
//            break;
//        }

//        case LV_EVENT_DEFOCUSED: {
//            Set_RefreshUI(obj, NULL, AMP_neg_SET_FORM, fabs(IF_Power_Get_OutCurr()));
//            break;
//        }
//        default: break;
//    }
